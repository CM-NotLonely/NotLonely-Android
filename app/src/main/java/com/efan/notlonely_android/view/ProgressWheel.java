...
/**
 * Created by linqh0806 on 2016/5/13.
 */
public class ProgressWheel extends View {
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            ...
            radius=(layout_width - paddingRight - barWidth-paddingLeft + barWidth)/2;
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isDrawFirst && !isDrawSecond) {
            ...
            if(isTick){
                //绘制打勾的第一条直线
                canvas.drawLine((float)(centerX-radius*0.8/1.4),centerY,
                        centerX-(float)(centerX-radius*0.8/1.4)+(float)(centerX-radius*0.8/1.4)*lineProgress,
                        (float)(centerY+radius*0.8/1.4*lineProgress),barPaint);
                //当绘制完第一条直线，开始绘制第二条
            }else{
                //绘制打叉的第一条直线
                canvas.drawLine((float)(centerX-radius*0.7/1.4),(float)(centerY-radius*0.7/1.4),
                        (float)(centerX-radius*0.7/1.4)+(float)(radius*0.7/1.4)*2*lineProgress,
                        (float)(centerY-radius*0.7/1.4)+(float)(radius*0.7/1.4)*2*lineProgress,barPaint);
            }
            ...
            if(isTick){
                //第一条直线
                canvas.drawLine((float)(centerX-radius*0.8/1.4),centerY,centerX,(float)(centerY+radius*0.8/1.4),barPaint);
                //第二条直线
                canvas.drawLine(centerX,(float)(centerY+radius*0.8/1.4),
                        (float)(centerX+radius*0.8/1.4*lineProgress),
                        centerY+(float)(radius*0.8/1.4)-(float)(2*radius*0.8/1.4*lineProgress),barPaint);
            }else {
                canvas.drawLine((float)(centerX-radius*0.7/1.4),(float)(centerY-radius*0.7/1.4),
                        (float)(centerX+radius*0.7/1.4),
                        (float)(centerY+radius*0.7/1.4),barPaint);
                canvas.drawLine((float)(centerX+radius*0.7/1.4),(float)(centerY-radius*0.7/1.4),
                        (float)(centerX+radius*0.7/1.4-radius*0.7/1.4*2*lineProgress),
                        centerY-(float)(radius*0.7/1.4)+(float)(2*radius*0.7/1.4*lineProgress),barPaint);
            }
