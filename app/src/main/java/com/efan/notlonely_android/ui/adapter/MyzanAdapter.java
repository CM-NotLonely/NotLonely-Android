 ...
 */
public class MyzanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private int BottomHeight=0;
    private Context mContext;
    private LayoutInflater mInflater;

    public MyzanAdapter(Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_myzan, parent, false);
    ...
    public class vHold extends RecyclerView.ViewHolder {
        ...
        public vHold(View itemView) {
            super(itemView);
            simpleDraweeView= (SimpleDraweeView) itemView.findViewById(R.id.praise_face);
        }
    }
}
