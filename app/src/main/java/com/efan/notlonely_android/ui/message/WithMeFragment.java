...
import com.efan.notlonely_android.ui.adapter.WithMeAdapter;
import com.efan.notlonely_android.view.BlurringView;

/**
 * Created by 一帆 on 2016/3/30.
 */
public class WithMeFragment extends BaseFragment {
    ...
    protected View inflaterView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
        View view = var1.inflate(R.layout.fragment_withme,var2,false);
        return view;
    }

    @Override
    public void initData() {
        adapter = new WithMeAdapter(getContext());
