...
public class MyjoinAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyjoinAdapter(Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_myjoin, parent, false);
    ...
    public class vHold extends RecyclerView.ViewHolder {
        ...
        public vHold(View itemView) {
            super(itemView);
            simpleDraweeView= (SimpleDraweeView) itemView.findViewById(R.id.join_face);
        }
    }
}
